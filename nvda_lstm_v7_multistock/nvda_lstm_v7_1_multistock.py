#!/usr/bin/env python3
"""
NVDA LSTM v7.1 - No-Leakage Strategy

V7.1 khac voi V7:
- Pretrain: 2015-2020 (5 nam) thay vi 2015-2025 (10 nam) - TRANH LEAKAGE
- Fine-tune: 2021-2024 (4 nam) thay vi 2021-2025 (4 nam) - TRANH LEAKAGE
...
def split_data_by_years_v7_1(df, feature_cols, predictor,
    ...
    print(f"\n{'='*60}")
    print("V7.1 Data Split by Years (No Leakage):")
    print(f"{'='*60}")
...
def main():
    parser = argparse.ArgumentParser(description='NVDA LSTM v7.1 - No-Leakage Strategy')
    ...
    print(f"\n{'='*60}")
    print(f"NVDA LSTM v7.1 - No-Leakage Strategy")
    print(f"{'='*60}")
    print(f"\nV7.1 Strategy (No Data Leakage):")
    ...
    print(f"\n{'='*60}")
    if use_fallback:
        print("Step 1: Pretrain trên 70% of 2021-2024 (Fallback - No 2015-2020 data) - V7.1")
    else:
        print("Step 1: Pretrain trên 2015-2020 (5 năm) - V7.1 No Leakage")
    print(f"{'='*60}")
    ...
    print(f"\n{'='*60}")
    print("Step 2: Fine-tune trên 2021-2024 (4 năm) - Freeze Encoder (V7.1 No Leakage)")
    print(f"{'='*60}")
    X_finetune, y_finetune_reg, _ = data_splits['finetune']
    ...
    torch.save(artifact, 'nvda_lstm_v7_1_artifact.pth')
    print(f"\n{'='*60}")
    print("V7.1 Artifact saved: nvda_lstm_v7_1_artifact.pth")
    print(f"{'='*60}")
